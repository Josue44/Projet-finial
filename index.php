   ...
   <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#!"><i class="fa fa-database" aria-hidden="true"></i>STORAGE SYSTEM  > Accueil</a>
        </div>
        ...
        <div  class="container">
          ...
          <div class="col-sm-10 col-sm-offset-1">
            ...
            <div  class="container1">
             ...
             <a href="compta.php"><h1>
               <i class="fa fa-btc" aria-hidden="true"></i></h1><br>
